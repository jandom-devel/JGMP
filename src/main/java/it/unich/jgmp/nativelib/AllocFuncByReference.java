...
/**
 * A structure containing an {@link AllocFunc} callback. This is used to pass
 * the callback by reference to native code.
 */
@FieldOrder({"value"})
public class AllocFuncByReference extends Structure {

    /**
     * Create an instance of this structure.
     */
    public AllocFuncByReference() {
        super();
    }
